...
class Input(BaseModel):
    prev_hash: Optional[str] = Field(
        None, description="Previous transaction hash")
...
class Output(BaseModel):
    ...
    spent_by: Optional[str] = Field(
        None, description="Transaction that spent this output")
    addresses: Optional[List[str]] = Field(
        None, description="List of addresses")
    # script_type: Optional[str] = Field(None, description="Script type")
...
class Tx(BaseModel):
    ...
    confirmed: Optional[datetime] = Field(
